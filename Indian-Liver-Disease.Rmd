...
And these are the most important variables from the over-sampling random forest.  Note here total bilirubin in the top spot.
...
And here is the variable importance results:
...
The difficulties with the size and balance of our data can further be seen by looking at variable importance.  Take a look at this graph showing the variable importance of our models from multinom, random forest and logistic regression (glm):
